...
},{"./UserShow":"src/views/UserShow.ts","./UserForm":"src/views/UserForm.ts","./View":"src/views/View.ts"}],"src/models/Attributes.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Model.prototype.save = function () {
    ...
    this.sync.save(this.attrs.getAll()).then(function () {
      _this.trigger('save');
    }).catch(function () {
      _this.trigger('error');
    });
...
function (_super) {
  ...
  User.buildUser = function (data) {
    return new User(new Attributes_1.Attributes(data), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(rootUrl));
  };
